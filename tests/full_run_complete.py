...
# This test works only on MR laptop, it is supposed to be skipped by the pytest command. After Issue #12 has been
# resolved it should replace test_full_run.py.
def test_full_run():
    """
