...
class EmissionModels:
    ...
    def set_metals_ref(self, metal):
        ...
        metal_idx = {'TheThreeHundred-1': [0],
                     'TheThreeHundred-2': np.arange(2, 30, 1),
        ...
        # self.json_record['metals_ref'][metal_idx.get(self.json_record['name'])] = metal
        # print(self.json_record['metals_ref'][metal_idx.get(self.json_record['name'])])
